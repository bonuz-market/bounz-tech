...
const de: Dictionary = {
	meta: {
		...
		keywords: [
			...
			"Web3-Entwicklung VAE",
			"digitale Identitätslösungen",
			"White-Label Krypto-Wallet",
			"Blockchain-Softwareentwicklung",
			"Selbstsouveränitätstechnologie",
			"Blockchain-Unternehmen Dubai",
			"Blockchain-Anwendungen für Verbraucher",
			...
			"DID-Lösungen",
			"Blockchain-Beratung Dubai",
			"Web3-Infrastruktur",
			"Onchain-Identität",
			"Treueprämien Blockchain",
			"Enterprise-Blockchain-Lösungen",
			"White-Label-Wallet-Plattform",
			"selbstsouveräne Identität",
			"Blockchain-App-Entwicklung VAE",
			"Technologieunternehmen Dubai",
			"Matthias Mende",
	...
	hero: {
		title: "Wir schmieden unsichtbare Technologie, die Menschen souverän macht.",
		subtitle:
	...
	ourWork: {
		title: "Unsere Arbeit",
		intro: "Beispiele dessen, was wir entwickeln:",
		wallet: {
		...
		id: {
			title: "bonuz ID",
			description:
				"Eine einheitliche Profilebene, auf der Menschen ihre Lieblingslinks, sozialen Netzwerke und Präsenz auf einer einfachen öffentlichen Seite verbinden. Wie Linktree, aber fortschrittlicher und kostenlos.",
		},
		dashboard: {
